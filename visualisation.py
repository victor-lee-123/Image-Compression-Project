#visualisation.py file handles all the visual outputs that help users understand what the algorithm is doing.
# 
# draws a seam as a red line on the image.
# helps the user visually understand the seam chosen by DP or Greedy.
